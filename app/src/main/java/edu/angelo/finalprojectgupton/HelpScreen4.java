...
public class HelpScreen4 extends Screen {
    ...
    public void present(float deltaTime) {
        ...
        g.drawRect(97, 0, World.WORLD_WIDTH-(96*2), World.WORLD_HEIGHT, Color.argb(150, 0, 255, 0));


        // draw player
        g.drawPixmap(Assets.player, 0, (6*32) - 96);
        ...
        // draw text
        g.drawPixmap(Assets.help4, 0, (7*32) - 96);
