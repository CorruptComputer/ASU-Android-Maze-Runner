...
public class HelpScreen6 extends Screen {
    public HelpScreen6(Game game) {
        super(game);
    }
    ...
    public void present(float deltaTime) {
        ...
        // draw text
        g.drawPixmap(Assets.help6, 3*32, (7*32) - 96);
        g.drawPixmap(Assets.wall4, 2*32, (6*32) - 96);
        g.drawPixmap(Assets.wall4, 4*32, (6*32) - 96);
        g.drawPixmap(Assets.wall4, 3*32, (5*32) - 96);
